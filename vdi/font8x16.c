...
/* static */ extern int16_t const off_8x16[];
/* static */ extern int16_t const dat_8x16[];
...
struct font_head const f8x16 ={
   ...
   "8x16 system font",	/*   char  name[32]	 	*/
    ...
    0,					/*   uint8_t *hor_table	 	*/
    (const uint16_t *)off_8x16,			/*   uint16_t *off_table	 	*/
