...
public class TOSLineFfix extends GhidraScript {
	...
	private Map<Integer, String> getLinefTrapTable() {
		...
		traptable.put(0xF564, "fc_init");
		traptable.put(0xF568, "fc_do");
		traptable.put(0xF56C, "fc_bar");
		traptable.put(0xF570, "xbios");
		traptable.put(0xF574, "do1_alert");
		traptable.put(0xF578, "bios");
		traptable.put(0xF57C, "fc_clfix");
		traptable.put(0xF580, "fc_draw");
		traptable.put(0xF584, "fc_alloc");
		traptable.put(0xF588, "fc_rwtracks");
		traptable.put(0xF58C, "err_trap");
		traptable.put(0xF590, "fc_swp68");
