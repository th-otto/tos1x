...
#define F1NAME                             7 /* FBOXTEXT in tree SELECTOR */
#define F2NAME                             8 /* FBOXTEXT in tree SELECTOR */
#define F3NAME                             9 /* FBOXTEXT in tree SELECTOR */
#define F4NAME                            10 /* FBOXTEXT in tree SELECTOR */
#define F5NAME                            11 /* FBOXTEXT in tree SELECTOR */
#define F6NAME                            12 /* FBOXTEXT in tree SELECTOR */
#define F7NAME                            13 /* FBOXTEXT in tree SELECTOR */
#define F8NAME                            14 /* FBOXTEXT in tree SELECTOR */
#define F9NAME                            15 /* FBOXTEXT in tree SELECTOR */
#define SCRLBAR                           16 /* BOX in tree SELECTOR */
#define FUPAROW                           17 /* BOXCHAR in tree SELECTOR */
#define FDNAROW                           18 /* BOXCHAR in tree SELECTOR */
#define FSVSLID                           19 /* BOX in tree SELECTOR */
#define FSVELEV                           20 /* BOX in tree SELECTOR */
