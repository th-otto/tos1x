/*
 * resource set indices for gemfi
 *
...
#  endif
#endif
extern _WORD gemfi_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD gemfi_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD gemfi_rsc_free(void);
#endif
