/*
 * resource set indices for gemus
 *
...
#define F2NAME                             7 /* FBOXTEXT in tree SELECTOR */
#define F3NAME                             8 /* FBOXTEXT in tree SELECTOR */
#define F4NAME                             9 /* FBOXTEXT in tree SELECTOR */
#define F5NAME                            10 /* FBOXTEXT in tree SELECTOR */
#define F6NAME                            11 /* FBOXTEXT in tree SELECTOR */
#define F7NAME                            12 /* FBOXTEXT in tree SELECTOR */
#define F8NAME                            13 /* FBOXTEXT in tree SELECTOR */
#define F9NAME                            14 /* FBOXTEXT in tree SELECTOR */
#define SCRLBAR                           15 /* FBOXTEXT in tree SELECTOR */
#define FUPAROW                           16 /* BOX in tree SELECTOR */
#define FDNAROW                           17 /* BOXCHAR in tree SELECTOR */
#define FSVSLID                           18 /* BOXCHAR in tree SELECTOR */
#define FSVELEV                           19 /* BOX in tree SELECTOR */
#define F1NAME                            20 /* BOX in tree SELECTOR */
...
#  endif
#endif
extern _WORD gemus_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD gemus_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD gemus_rsc_free(void);
#endif
