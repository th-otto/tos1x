...
BOOLEAN dos_sfirst PROTO((const char *name, int attrib));
BOOLEAN dos_snext PROTO((NOTHING));
int dos_open PROTO((const char *name, int mode));
int dos_close PROTO((int fd));
long dos_read PROTO((int fd, size_t size, VOIDPTR buf));
long dos_write PROTO((int fd, size_t size, VOIDPTR buf));
