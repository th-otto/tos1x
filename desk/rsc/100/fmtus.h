/*
 * resource set indices for fmtus
 *
...
#  endif
#endif
extern _WORD fmtus_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD fmtus_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD fmtus_rsc_free(void);
#endif
