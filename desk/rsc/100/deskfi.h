/*
 * resource set indices for deskfi
 *
...
#endif
#ifndef __ALCYON__
#define RSC_NAME "deskfi"
#endif
#ifdef RSC_ID
#undef RSC_ID
#endif
#ifdef deskfi
#define RSC_ID deskfi
#else
#define RSC_ID 0
#endif
...
#  endif
#endif
extern _WORD deskfi_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD deskfi_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD deskfi_rsc_free(void);
#endif
