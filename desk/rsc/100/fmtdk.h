/*
 * resource set indices for fmtdk
 *
...
#  endif
#endif
extern _WORD fmtdk_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD fmtdk_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD fmtdk_rsc_free(void);
#endif
