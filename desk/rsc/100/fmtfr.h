/*
 * resource set indices for fmtfr
 *
...
#  endif
#endif
extern _WORD fmtfr_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD fmtfr_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD fmtfr_rsc_free(void);
#endif
