/*
 * resource set indices for fmtfi
 *
...
#  endif
#endif
extern _WORD fmtfi_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD fmtfi_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD fmtfi_rsc_free(void);
#endif
