/*
 * resource set indices for deskse
 *
 ...
 * Number of Images:         11
 * Total file size:          11434
 */

#undef RSC_NAME
#ifndef __ALCYON__
#define RSC_NAME "deskse"
#endif
#undef RSC_ID
#ifdef deskse
#define RSC_ID deskse
#else
#define RSC_ID 0
#endif
...
#  endif
#endif
extern _WORD deskse_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD deskse_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD deskse_rsc_free(void);
#endif
