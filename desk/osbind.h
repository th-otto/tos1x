...
/*	BIOS	(trap13)	*/
#define	Bconstat(a)	trp13(1,a)
#define	Bconin(a)	trp13(2,a)
#define	Bconout(a,b)	trp13(3,a,b)
#define	Rwabs(a,b,c,d,e)	trp13(4,a,b,c,d,e)
#define	Setexc(a,b)	trp13(5,a,b)
#define	Getbpb(a)	trp13(7,a)	/*	4/22/86	Derek Mui	*/
#define	Bcostat(a)	trp13(8,a)
#define	Mediach(a)	trp13(9,a)
#define	Drvmap()	trp13(10)
#define	Getshift(a)	trp13(11,a)

/*	XBIOS	(trap14)	*/
#define	Initmous(a,b,c)	xbios(0,a,b,c)
#define	Physbase()	xbios(2)
#define	Logbase()	xbios(3)
#define	Getrez()	(int)trp14(4)
